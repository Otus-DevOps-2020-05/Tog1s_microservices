...
- Развернули ingress контроллер.
- Развернули prometheus.
- Развернули grafana для визуализации.
- Настроили дашборды и неймспейсы.
- Параметризовали дашборды.
- Развернули EFK для агрегации логов.
